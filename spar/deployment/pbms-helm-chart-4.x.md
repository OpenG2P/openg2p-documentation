...
The changes made SPAR Helm Chart w.r.t previous versions (1.x and below) are similar to [Registry Helm Chart 3.x.](../../social-registry/deployment/registry-helm-chart-3.x.x.md)   Important reference and points to note are listed below:
