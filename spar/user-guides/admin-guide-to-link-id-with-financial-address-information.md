...
1. The administrator must clone the SPAR repository [https://gitlab.com/openg2p/spar/spar](https://gitlab.com/openg2p/spar/spar) and locate the admin/seed scripts within it.
