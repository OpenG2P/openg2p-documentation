...
1. The administrator must clone the SPAR repository [https://github.com/OpenG2P/spar](https://github.com/OpenG2P/spar) and locate the admin/seed scripts within it.
