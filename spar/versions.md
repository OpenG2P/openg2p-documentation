...
## 👉 [SPAR — Versions & Changelog](https://openg2p.github.io/versions/spar-spar/CHANGELOG.html)
...
* **Helm charts** are published to the **shared OpenG2P Helm registry**, so one
  ...
  [hub.docker.com/u/openg2p](https://hub.docker.com/u/openg2p).
* **Docker images** live in **each repo's own Container Registry** — SPAR's are at
  `openg2p/openg2p-spar/<name>` (`mapper-partner-api`, `bene-portal-api`).
...
builds; for those, always use the [changelog page](https://openg2p.github.io/versions/spar-spar/CHANGELOG.html) above.
