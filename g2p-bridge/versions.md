...
* The **current, consolidated** chart is named **`openg2p-bridge`**, and in the **Rancher** catalog it appears as **“OpenG2P Bridge”**. This is the one to install for any new deployment (see [G2P Bridge Helm Package](#g2p-bridge-helm-package) below).
* The **legacy**, multi-chart line is named **`openg2p-g2p-bridge`**, and in **Rancher** it appears as **“OpenG2P G2P Bridge”** (see [Legacy Versions](#legacy-versions) below).
