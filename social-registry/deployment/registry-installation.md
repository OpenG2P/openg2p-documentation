...
The instructions here pertain to the deployment of Registry and associated components on the Kubernetes cluster using [Registry Helm chart](../developer-zone/registry-helm-chart-3.x.x.md).  All the components are installed in the same namespace.&#x20;
