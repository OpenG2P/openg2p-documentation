...
[<mark style="color:blue;">**PBMS uses Keycloak for user identity management, authentication, and authorization. In Keycloak, the high-level groups described above must be defined as roles**</mark>](#user-content-fn-1)[^1] <mark style="color:blue;">**and associated to users.**</mark>
