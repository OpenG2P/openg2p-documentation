...
1. Create an [eSignet OIDC client](../../../../../products/registry/registry/_archive/social-registry/features/id-integration/id-authentication/user-guides/esignet-client-creation.md) with the following parameters:
