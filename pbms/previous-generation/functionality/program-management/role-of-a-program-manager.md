...
In OpenG2P, in each programs' configuration tab, you can find the various managers, such as, [Eligibility Managers](../eligibility/), [Deduplication Managers](../deduplication/), [Notification Managers](../notifications/), Program Manager, Cycle Manager, [Entitlement Manager](../entitlement/), and Payment Manager.
...
To know about Program disbursement cycles, [click here](../program-disbursement-cycles/)
