...
9. MOSIP Partner Specific User Token (PSUT) ID type is configured. See [Configure ID Types](../../functionality/beneficiary-management/user-guides/configuration/configure-id-types.md).
