...
* Define eligibility and entitlement rules like [Proxy Means Test](../products/pbms/_archive/previous-generation/functionality/eligibility/proxy-means-test.md) (**PMT)** to automatically create eligible beneficiaries
* Maintain[ **beneficiary registry**](../products/pbms/_archive/previous-generation/functionality/beneficiary-management/beneficiary-registry/)**.**
* Enable [**digital cash transfer**](../g2p-bridge/) by seamlessly connecting to payment systems
* Offer [**self-service portal**](../products/pbms/_archive/previous-generation/functionality/self-service-portal/) to residents
* Send [**notifications**](../products/pbms/_archive/previous-generation/functionality/notifications/) to beneficiaries via SMS and email
* Issue digitally signed [**e-Vouchers**](../products/pbms/_archive/previous-generation/functionality/disbursement-cycles/e-voucher.md) to beneficiaries
