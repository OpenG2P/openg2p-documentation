...
Eligibility metrics are primarily derived from the `registry_summary` section of the API response. This section contains registry-type specific statistics (e.g., for a farmer registry: land holding mean, quartiles; or for a households registry: household-size statistics).
