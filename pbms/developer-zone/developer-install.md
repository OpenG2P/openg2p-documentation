...
2.  Clone the [OpenG2P PBMS modules](repositories.md) form github.
...
3.  Install the required Python libraries for all the custom-addons.
    ...
    pip3 install -r requirements.txt
    ```
4. Add addons directory path to the _odoo.conf_ file in **addons\_path** parameter, mentioned in [point 7](developer-install.md#id-7.-configure-odoo).
5. For the PBMS Odoo to function properly, your add-ons should include the packages listed below:
   * [https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-odoo/3.0.0.txt](https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-odoo/3.0.0.txt)
6. For PBMS Background tasks to fucntion properly you should have these packages in your local filesystem:
   * [https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-api.txt](https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-api.txt)
   * [https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-celery-beat.txt](https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-celery-beat.txt)
   * [https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-celery-worker.txt](https://github.com/OpenG2P/openg2p-pbms-docker/blob/3.0/openg2p-pbms-bg-tasks/bg-task-celery-worker.txt)
