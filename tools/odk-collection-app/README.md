...
The app also has an integrated QR code scanning application to scan the ID card of the registrant. The scanning application automatically populates the KYC data of the registrant in the ODK form and verifies the digital signature to establish the card's authenticity.<br>
...
The field registration agent downloads the ODK form using the ODK Collect App. To learn the steps, click [here](user-guides/download-form-on-odk-collect.md).
...
:notebook\_with\_decorative\_cover:[Provide ODK Form Access to Field Agent](user-guides/provide-form-access-to-field-agent.md)
