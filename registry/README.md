---
description: >-
  OpenG2P Registry is an open-source, metadata-driven platform for building
  functional registries of individuals, non-human entities, and groups that fit
  into a country's digital public infrastructure (DPI).
---
