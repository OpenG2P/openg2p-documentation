...
The `G2PRegisterSchema` metadata table stores **JSON-based configuration schemas** used by the platform to control **deduplication, search results, and filtering behavior** for each register.
