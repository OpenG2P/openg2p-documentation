...
8. Another dialogue box appears. Configure the entitlement manager details as described in the [Create Entitlement Manager Type](../../../pbms/previous-generation/functionality/entitlement/user-guides/create-entitlement-manager-type/) guide.
