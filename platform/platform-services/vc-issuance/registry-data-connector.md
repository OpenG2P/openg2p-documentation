...
=======
  ...
  SQL and a configurable token-claim → query-param
...
binding.
=======
At issuance, Certify needs the citizen's claim data. OpenG2P supplies it with a **custom DataProvider plugin** — `registry-dataprovider-plugin` — that reads an **external Registry database** with **configurable, scope-based SQL** and a **configurable claim→parameter** binding.
>>>>>>> bcdebf767dfd6680471f911efd7317fc9b3f4214
