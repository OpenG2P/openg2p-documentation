...
To know more on export beneficiaries approved entitlements, [click here](user-guides/export-beneficiaries-approved-entitlement.md).

## Related user guides

:notebook\_with\_decorative\_cover:[Create Entitlement Manager Type](user-guides/create-entitlement-manager-type/)

:notebook\_with\_decorative\_cover:[Configure Entitlement Manager in the Program](../../../../../../resources/_archive/guides/user-guides/pbms/create-entitlement-manager-type-1.md)

:notebook\_with\_decorative\_cover:[Create Entitlement Voucher Template](user-guides/create-entitlement-voucher-template.md)

:notebook\_with\_decorative\_cover:[Multi-Stage Approval](user-guides/multi-stage-approval.md)

:notebook\_with\_decorative\_cover:[Export Beneficiaries Approved Entitlements](user-guides/export-beneficiaries-approved-entitlement.md)
