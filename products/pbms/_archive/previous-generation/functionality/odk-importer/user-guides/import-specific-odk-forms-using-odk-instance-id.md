...
8. Fill in the remaining fields following the [import record configuration](customize-the-odk-importer-configuration-based-on-the-odk-form-fields.md) procedure.
