...
:notebook\_with\_decorative\_cover:[Configure Program Manager in Program](../../../../../../resources/_archive/guides/user-guides/pbms/configure-program-manager-in-program.md)

:notebook\_with\_decorative\_cover:[Create and Approve Program Cycle](in-kind-transfer/user-guides/create-and-approve-disbursement-cycle.md)
