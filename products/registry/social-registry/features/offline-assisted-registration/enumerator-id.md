...
When an [Enumerator](/broken/pages/tR6v0aIsWGZ0qX1cAc41) is added to the Registration Portal, a unique ID is automatically generated and assigned. This ID is the **Enumerator ID (EID)** which serves as a unique identifier for each enumerator in the SR.
