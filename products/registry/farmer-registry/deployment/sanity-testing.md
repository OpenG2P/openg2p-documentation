...
The Farmer Registry image is a thin `FROM` of it that layers on **Set 2 — the field-specific parts**, four files in [`test/sanity`](https://gitlab.com/openg2p/registry/farmer-registry/-/tree/develop/test/sanity):
