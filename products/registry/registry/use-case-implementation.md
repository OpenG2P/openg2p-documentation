...
5. **Resource requirements** — recommended deployment architecture (`single-node`, `production`, or `high-availability`) and compute specifications for development sandbox, pilot, and production environments. Sourced from the knowledge base only.
