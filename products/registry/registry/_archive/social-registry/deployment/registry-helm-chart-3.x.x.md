...
The ID Generator requires `mosip_kerne`l database to be created. <mark style="color:orange;">This is currently created under Registry, but ideally,</mark> <mark style="color:orange;">`mosip_kerne`</mark><mark style="color:orange;">l could be part of</mark> <mark style="color:orange;">`openg2p-commons`</mark> <mark style="color:orange;">(TBD)</mark>.
