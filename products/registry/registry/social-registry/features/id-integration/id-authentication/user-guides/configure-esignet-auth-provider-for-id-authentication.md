...
* Create two ID types on the Registry such as `NATIONAL ID` and `NATIONAL ID TOKEN`. To configure ID types refer the [Configure ID Types](../../../../../../../../pbms/previous-generation/functionality/beneficiary-management/beneficiary-registry-configurations/user-guides/configure-id-types.md) documentation.
* Install the [OpenID Connect Authentication](../../../../../../../../pbms/previous-generation/developer-zone/odoo-modules/openid-connect-authentication.md) and [G2P Auth: OIDC - Reg ID](../../../../../../../../pbms/previous-generation/developer-zone/odoo-modules/authentication-oidc-reg-id.md) module.
