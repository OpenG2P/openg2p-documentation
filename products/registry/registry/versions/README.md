...
This section tracks the released and in-progress versions of the OpenG2P Registry (Gen 2) Helm chart (`openg2p-registry`). For full deployment details of the current line, see [Helm Chart 4.x](../deployment/helm-chart-4.x.md).
