...
| **Description**       | First tagged release of the consolidated OpenG2P Registry platform source repository. All core libraries, APIs, Celery runtimes and UI code now live in a single repo, replacing the deprecated `openg2p-registry-gen2-`* split. |
| **Previous Version**  | —                                                                                                                                                                                                                                |
