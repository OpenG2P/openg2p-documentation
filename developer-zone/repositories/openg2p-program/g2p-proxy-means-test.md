...
* To create the [PMT Parameters](../../../user-guides/platform-guides/registration/eligibility-and-program-enrollment/configuration/configure-proxy-mean-test.md#steps-to-add-computed-fields) turn on the developer mode.
