...
* [📔 How-To Guides](guides/user-guides/README.md)
  ...
  * [Registration](guides/user-guides/registration/README.md)
    ...
    * [Online Self Registration](guides/user-guides/registration/online-self-registartion.md)
  ...
  * [Create Payment Managers Types](guides/user-guides/create-payment-manager-1/README.md)
    * [Create Payment Hub EE Payment Manager](guides/user-guides/create-payment-manager-1/create-payment-hub-ee-payment-manager.md)
    * [Create Payment Interoperability Layer Payment Manager](guides/user-guides/create-payment-manager-1/create-payment-interoperability-layer-payment-manager.md)
    * [Create Default Payment Manager](guides/user-guides/create-payment-manager-1/create-default-payment-manager.md)
