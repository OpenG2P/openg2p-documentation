  ...
  * [Features](pbms/functionality/README.md)
    * [Program Management](pbms/features/program-management.md)
      ...
      * [User Guides](pbms/features/program-management/user-guides/README.md)
        ...
        * [Create Notification Manager under Program](pbms/features/program-management/user-guides/configure-notification-manager.md)
        ...
        * [Create Manager Type](pbms/features/program-management/user-guides/create-manager-type/README.md)
          * [Create Notification Manager Types](pbms/features/program-management/user-guides/create-manager-type/create-notification-manager-types/README.md)
            * [Create SMS Notification Manager](pbms/features/program-management/user-guides/create-manager-type/create-notification-manager-types/create-sms-notification-manager.md)
            * [Create Email Notification Manager](pbms/features/program-management/user-guides/create-manager-type/create-notification-manager-types/create-email-notification-manager.md)
            * [Create Fast2SMS Notification Manager](pbms/features/program-management/user-guides/create-manager-type/create-notification-manager-types/create-fast2sms-notification-manager.md)
...
* [G2P Cash Transfer Bridge](g2p-cash-transfer-bridge/README.md)
  ...
  * [Development](g2p-cash-transfer-bridge/development/README.md)
    * [Design Specifications](g2p-cash-transfer-bridge/development/design-specifications/README.md)
      * [objects & tables](g2p-cash-transfer-bridge/development/design-specifications/objects-and-tables/README.md)
        * [disbursement\_envelope](g2p-cash-transfer-bridge/development/design-specifications/objects-and-tables/disbursement\_envelope.md)
        * [disbursement](g2p-cash-transfer-bridge/development/design-specifications/objects-and-tables/disbursement.md)
        * [benefit\_program](g2p-cash-transfer-bridge/development/design-specifications/objects-and-tables/benefit\_program.md)
      * [batch jobs](g2p-cash-transfer-bridge/development/design-specifications/batch-jobs/README.md)
        * [check\_funds\_with\_sponsor\_bank](g2p-cash-transfer-bridge/development/design-specifications/batch-jobs/check\_funds\_with\_sponsor\_bank.md)
