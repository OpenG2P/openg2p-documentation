...
Any channel you leave blank stays inactive. Log-based alerts (Loki LogQL rules) route to the same Alertmanager. The manual procedure below is the **legacy / self-managed** path — use it only if you are not deploying with the automation.
{% endhint %}
...
2. **Deploy alerting configuration to kuberenets cluster.**
   ...
   8.  Verify whether the alerts are firing from the Prometheus UI and check if Slack notifications are being received.<br>
       ...
       <figure><img src="../../.gitbook/assets/image (1) (1) (1).png" alt=""><figcaption><p><em><strong>slack channel</strong></em></p></figcaption></figure>
