...
Several applications in any installation of OpenG2P like the Rancher admin console, Grafana (logs/metrics), portals etc.  You can find the exact names of the URLs as follows:
