...
The table below specifies typical requirements for V4 deployment architecture in [**Development Mode**.](./#deployment-modes) For high availability and greater resilience, you will need additional hardware - refer to the [production guide](production.md).&#x20;
