...
A 3 digit version of a chart is considered 'frozen'. See more details about versioning [here](../operations/deployment/_archive/versioning.md#frozen-versions). Charts that are not frozen will have `-develop` tag. Examples:
