...
The [Private Access Channel](../../deployment-guide/private-access-channel.md) page covers the underlying pattern. The public (citizen) channel becomes active once environment automation lands.
